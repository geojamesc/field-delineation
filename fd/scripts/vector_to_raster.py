...
from fd.gsaa_to_eopatch import GsaaToEopatchConfigGpkg, get_gsaa_to_eopatch_workflow
...
def rasterise_gsaa(config: dict):
    ...
    #     roi_filename=config['roi_filename'],
    #     reference_data_filename=config["reference_data_filename"]
    # )

    gsaa_to_eops_config = GsaaToEopatchConfigGpkg(
        bucket_name=config['bucket_name'],
        aws_access_key_id=config['aws_access_key_id'],
        aws_secret_access_key=config['aws_secret_access_key'],
        aws_region=config['aws_region'],
        ...
        no_data_value=config['no_data_value'],
        disk_radius=config['disk_radius'],
        roi_gpkg_filename=config['roi_gpkg_filename'],
        reference_data_gpkg_filename=config["reference_data_gpkg_filename"]
    )
